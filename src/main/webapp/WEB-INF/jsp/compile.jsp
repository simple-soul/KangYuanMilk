...
<head>
    ...
    <link rel="stylesheet" href="../../js/lib/dist/css/wangEditor.css">
    ...
    <script type="text/javascript" src="../../js/lib/zh_CN.js"></script>
    <script type="text/javascript" src="../../js/lib/dist/js/wangEditor.js"></script>
