    ...
    <div class="tpl-login">
        <div class="tpl-login-content">
            ...
            <form class="am-form tpl-form-line-form" id="login">
                ...
                <div class="am-alert am-alert-danger" data-am-alert hidden="hidden" id="alert_username">
                ...
                <div class="am-alert am-alert-danger" data-am-alert hidden="hidden" id="alert_password">
                    <button type="button" class="am-close">&times;</button>
                    <p></p>
                </div>
                ...
                <div class="am-form-inline">
                    ...
                    <div class="am-form-group">
                        <input type="text" id="doc-ipt-error" class="am-form-field" name="code" placeholder="验证码">
                    </div>
                ...
                <div class="am-alert am-alert-danger" data-am-alert hidden="hidden" id="alert_code">
                    <button type="button" class="am-close">&times;</button>
                    <p></p>
                </div>
                ...
                <div class="am-alert am-alert-danger" data-am-alert hidden="hidden" id="alert_all">
                    <button type="button" class="am-close">&times;</button>
                    <p></p>
                </div>
